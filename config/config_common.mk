...
## need compile so in /system/lib/ and /system/vendor/lib on android O
COMPILE_SO_IN_VENDOR = no

ifeq ($(OREO_AND_NEWER), yes)
COMPILE_SO_IN_VENDOR = yes
endif
# soft decoder can not compile on android O, so compile soft decoder on android M
ifeq ($(PLATFORM_SDK_VERSION), $(SDK_LEVEL_M))
COMPILE_SO_IN_VENDOR = yes
endif
